...
Bran Lapillo è un genasi del fuoco, un omone raggomitolato in se stesso, ingobbito[^1]. Indossa un'armatura che assomiglia a una vecchia caldaia o stufa, costruita in [[Nerivium]][^2]. Sotto l'elmo, il suo volto è fatto di puro fuoco[^2]. È costantemente in controllo delle proprie emozioni e dei propri poteri[^1].

## Storia nelle Sessioni

- **Sessione 1**: Viene introdotto come uno dei membri del gruppo[^1].
- **Sessione 6**: Fornisce consigli sulla spedizione al [[Vulcano]], spiegando che chi può abitare serenamente il vulcano sono persone come lui, come [[Pagrax]] e i giganti del fuoco[^3].
- **Sessione 7**: Si toglie l'elmo rivelando la sua faccia di fuoco[^2]. Parla del [[Nerivium]] e delle sue proprietà[^2]. Aiuta a riparare gli spifferi della casa con muschio e resina[^2]. Dona 130 GP per la costruzione del bar[^2].
...
La moglie di Bran Lapillo, ora deceduta. Era allieva di [[Awen Seife]] e molto legata a lei[^5]. Fu lei a far conoscere Bran e Awen[^5].

## Visita alla Corte Splendente

Bran e [[Awen Seife]] sono stati ospiti alla [[I Regni Fatati|Corte Splendente]][^7]. Quando Awen menzionò il [[Catrador]], gli esseri fatati reagirono con profondo turbamento e lo sguardo di [[Cernunnos]] cambiò[^8]. Bran dovette usare mezzi estremi per scappare[^7]. Awen nota che "è strano che relazioni così durature possano cambiare così in fretta con una parola"[^8].
